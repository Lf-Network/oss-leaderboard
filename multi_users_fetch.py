...
def fetch_contributions_for_multi_users(query: str, variables: Dict) -> pd.DataFrame:
    ...
    for userName in user_list:
        ...
        while True:
            ...
            if(not page_info_T1["hasNextPage"] and 
                not page_info_T2["hasNextPage"] and
                not page_info_T3["hasNextPage"] and
                not page_info_T4["hasPreviousPage"] and
                not page_info_T5["hasNextPage"]
            ):
                break
