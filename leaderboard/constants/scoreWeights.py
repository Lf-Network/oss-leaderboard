...
T4S1 = 0.1  # score for 'Commented on issue created by user in the repo owned by the use'
T4S2 = 0.1  # score for 'Commented on issue not created by user in the repo owned by the user'
T4S3 = 0.1  # score for 'Commented on issue created by user in the repo not owned by the user'
T4S4 = 0.1  # score for 'Commented on issue not created by user in the repo not owned by the user'
