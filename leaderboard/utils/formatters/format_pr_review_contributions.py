        ...
        [
            {
                ...
                "pr_status": pr_review["node"]["pullRequestReview"]["pullRequest"]["state"],
                "author_id": (pr_review["node"]["pullRequestReview"]["pullRequest"].get("author") or {}).get("id", ""),
                "merged_by_id": pr_review["node"]["pullRequestReview"]["pullRequest"].get("mergedBy", {}).get("login", "") if pr_review["node"]["pullRequestReview"]["pullRequest"].get("merged") else "",
                "reactions": pr_review["node"]["pullRequestReview"]["reactions"]["totalCount"],
